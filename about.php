          ...
          <section>
            <div class="row">
              <div class="col-md-3 col-lg-3 col-xl-3 mx-auto">
                ...
                <p>
                  <strong> EpicBooks </strong>is your go-to destination for discovering the latest and greatest in books. From bestselling novels to hidden gems, we bring you a curated selection of reads to inspire and entertain.
                </p>
              </div>
      
              <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-0 px-2 ">
                <h5 class="mb-4 font-weight-bold px-2   ">LINKS</h5>
                <p><a  href="books.php" style="text-decoration: none;">Books</a></p>
